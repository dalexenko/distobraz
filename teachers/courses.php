...
// Records List
if ($action == 'list'){
  $query = "SELECT * FROM courses where user_id=".$user["login"];
  if ($find != ''){
  $query = $query . " and (course_id LIKE '%$find%' OR course_name LIKE '%$find%' OR control_id LIKE '%$find%' OR success_count LIKE '%$find%')";
  }
  if ($orderby != ''){
  ...
  print "<td><a href=\"$PHP_SELF?stpage=$stpage&find=$find&orderby=course_name\"><img src=\"../pics/arrow.gif\" alt=\"Order by field course_name\" border=\"0\"><br><b>course_name</b></a></td>\n";
  ...
  print "<td><a href=\"$PHP_SELF?stpage=$stpage&find=$find&orderby=success_count\"><img src=\"../pics/arrow.gif\" alt=\"Order by field success_count\" border=\"0\"><br><b>success_count</b></a></td>\n";
...
function print_form($row) {
  ...
  print "<tr><td>control_id: </td><td><input type=\"text\" name=\"control_id\" value=\"$control_id\"></td></tr>\n";
