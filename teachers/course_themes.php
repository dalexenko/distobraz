...
if ($action == 'list'){
  ...
  print "<td><a href=\"$PHP_SELF?course_id=$course_id&stpage=$stpage&find=$find&orderby=course_id\"><img src=\"../pics/arrow.gif\" alt=\"Order by field course_id\" border=\"0\"><br><b>course_id</b></a></td>\n";
  ...
  print "<input type=\"submit\" value=\"Добавить новую тему курса\"></form>\n";
}
...
// Delete Record
if ($action == 'delete'){
  $deldirquery ="select course_id, theme_id from course_themes WHERE (theme_id=$id)";
  ...
  print "<meta http-equiv='refresh' content=\"0;URL=$PHP_SELF?course_id=$delrow[0]&stpage=$stpage&orderby=$orderby&find=$find\">";
  }
}
